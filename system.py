...
original_list = ['Home','Tool Wear Detection', 'Tool Wear Prediction', 'Tool Performance', 'Tool Analysis', 'Outlier Detection','Tool Detection','Tips','Data Analysis']
    ...
    def cov_matrix(data, verbose=False):
        ...
        if is_pos_def(covariance_matrix):
            ...
            if is_pos_def(inv_covariance_matrix):
                ...
                st.write("Error: Inverse of Covariance Matrix is not positive definite!")
        else:
                st.write("Error: Covariance Matrix is not positive definite!")
...
if result == 'Tool Analysis':
    ...
    for i in range(1,19):
        ...
        frame = pd.read_csv(f"E:/hset/New folder/experiment_{exp_num}.csv")
